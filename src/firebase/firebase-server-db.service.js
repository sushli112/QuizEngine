...
function storeChallenges(challenges){
    ...
    var challengesRef = firebaseDB.ref("challenges/");
...
function fetchChallengesById(id) {
    ...
    function fetchChallengeByIdFromSocial(id) {
        ...
        return new Promise(function (resolve, reject) { 
             ...
             .get('https://quizrtsocial.herokuapp.com/api/getParticularChallenge?challengeId='+id
                 ...
                 storeChallengeQuestions(res.text);
                 resolve(res.text);
                 }
             })
        });
    ...
    function savePlayedChallengeInfo(challengeInfo){
        ...
        challengesList.child(key).set(challengeInfo);
    }
